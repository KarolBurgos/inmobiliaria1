<%-- 
    ...
    Created on : 30/04/2017, 05:48:42 PM
    Author     : usuario
--%>
...
<html>
  ...
  <div class="container-fluid">
    ...
    <center>
        ...
        <br>
        <br>
        EN VENTA<input type="checkbox" name="en venta" value="ON" />        EN ARRIENDO<input type="checkbox" name="en arriendo" value="ON" />
        <br>
        <br>
        <br>
        TIPOS DE PROPIEDAD <select name="">
            <option>CASA</option>
        ...
        <br>
        <br>
        <input type="submit" value="moodificar" />
    </center>
    </body>
</html>
